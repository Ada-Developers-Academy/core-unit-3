...
2. **Merge** the sub-arrays into one array by combining two sub-arrays into one at each step.
...
For the first *divide* step, the *midway index* will be *(0+7)/2* i.e. *3* (by considering the floor of *3.5*).
