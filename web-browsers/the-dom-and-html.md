...
Here is a sample webpage with the DOM structure above, written in HTML. We will learn more about HTML in the next section. In DevTools, you can collapse and expand child elements with the dropdown arrows left of the parent element.
